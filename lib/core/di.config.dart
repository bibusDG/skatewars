...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i14.ShowSkateSpotsDataSource>(
        () => _i14.ShowSkateSpotDataSourceImp());
    gh.singleton<_i15.SpotDetailsRepo>(() => _i16.SpotDetailsRepoImp(
        spotDetailsDatasource: gh<_i6.SpotDetailsDatasource>()));
    gh.factory<_i17.GetSpotDetailsUseCase>(
        () => _i17.GetSpotDetailsUseCase(repo: gh<_i15.SpotDetailsRepo>()));
    gh.singleton<_i18.AddSkateSpotDataSource>(() => _i18.AddSkateSpotDataImp());
    gh.singleton<_i19.ShowSkateSpotsRepo>(() => _i20.ShowSkateSpotRepoImp(
        showSkateSpotsDataSource: gh<_i14.ShowSkateSpotsDataSource>()));
    gh.singleton<_i21.AddSkateSpotRepo>(() => _i22.AddSkateSpotRepoImp(
        addSkateSpotDataSource: gh<_i18.AddSkateSpotDataSource>()));
    gh.factory<_i23.SpotDetailsCubit>(() => _i23.SpotDetailsCubit(
        getSpotDetailsUseCase: gh<_i17.GetSpotDetailsUseCase>()));
    gh.factory<_i24.AddSkateSpotUseCase>(
        () => _i24.AddSkateSpotUseCase(repo: gh<_i21.AddSkateSpotRepo>()));
    gh.factory<_i25.AddSpotMapCubit>(() => _i25.AddSpotMapCubit(
        getUserCurrentPositionUseCase:
            gh<_i7.GetUserCurrentPositionUseCase>()));
    gh.factory<_i26.UserAuthCubit>(() => _i26.UserAuthCubit(
    ...
    gh.factory<_i27.ShowSkateSpotsUseCase>(() => _i27.ShowSkateSpotsUseCase(
        showSkateSpotsRepo: gh<_i19.ShowSkateSpotsRepo>()));
    gh.factory<_i28.ShowSkateSpotsCubit>(() => _i28.ShowSkateSpotsCubit(
          showSkateSpotsUseCase: gh<_i27.ShowSkateSpotsUseCase>(),
          getUserCurrentPositionUseCase:
              gh<_i7.GetUserCurrentPositionUseCase>(),
          getUserByIDUseCase: gh<_i12.GetUserByIDUseCase>(),
        ));
    gh.factory<_i29.AddSkateSpotCubit>(() => _i29.AddSkateSpotCubit(
          addSkateSpotUseCase: gh<_i24.AddSkateSpotUseCase>(),
          getUserCurrentPositionUseCase:
              gh<_i7.GetUserCurrentPositionUseCase>(),
        ));
    return this;
